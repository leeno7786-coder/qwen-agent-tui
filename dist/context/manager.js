...
export class ContextManager {
    ...
    messageTokenCache = new Map();
    cachedTotalTokens = 0;
    constructor(cfg, messages = []) {
    ...
    addMessage(message) {
        ...
        if (this.config.maxHistoryTokens > 0 &&
            ...
            console.warn(`[ContextManager] Context approaching limit: ` +
     ...
     */
    generateCompactionSummary(removedMessages) {
        const summaries = [];
 ...
 */
export function createContextManager(cfg, messages = []) {
